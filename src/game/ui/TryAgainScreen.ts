...
export class TryAgainScreen {
  ...
  constructor(
    textures: Pick<CyberTextures, "tryAgainReference" | "scorePanel">,
  ) {
    this.background = new Sprite(textures.tryAgainReference);
  ...
  private layoutScorePanel() {
    ...
    this.scorePanel.position.set(GAME_WIDTH / 2, 640);
    ...
    this.scoreValue.position.set(GAME_WIDTH / 2, 650);
  }
